...
class _StorePageState extends State<StorePage> {
  ...
  Widget _buildGoldDisplay() {
    return Container(
      ...
      child: Row(
        ...
        children: [Text('金币数量: ${widget.player.money}')],
      ),
    );
  }
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            ElevatedButton(onPressed: _buyItem, child: const Text('购买')),
          ],
        ),
      ),
    );
  ...
  void _buyItem() {
    if (widget.player.money >= _selectedItem.price) {
      ...
      BannerTemplate.snackBarDialog(context, '购买成功');
    } else {
      BannerTemplate.snackBarDialog(context, '金币不足');
    }
  }
}
